package io.playn.template.robovm;
...
public class TemplateGameRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, TemplateGameRoboVM.class);
    pool.close();
  }
}
